...
<head>
  ...
  <link rel="shortcut icon" href="../admin/img/logo.ico">
...
?>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">ระบบเช็คชื่อนักศึกษา (นักศึกษา)</a>
    <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="รายงานการเข้าเรียน">
          <a class="nav-link" href="index.php">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">รายงานการเข้าเรียน</span>
          </a>
        </li>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php">
            <i class="fa fa-user-circle"></i><?php echo ' '.$_SESSION["Name"]; ?></a>
        </li>
